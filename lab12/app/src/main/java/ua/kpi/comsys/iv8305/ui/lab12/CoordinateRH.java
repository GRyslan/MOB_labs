...
public class CoordinateRH {
    private Direction direction;
    private int degrees;
    private int minutes;
    private int seconds;

    public CoordinateRH (Direction d) {
        this.direction = d;
        this.degrees = 0;
        this.minutes = 0;
        this.seconds = 0;
    ...
    public CoordinateRH (Direction d, int deg, int min, int sec) throws Exception {
    ...
    public CoordinateRH middleWith(CoordinateRH coordTD) {
        return middleTwo(this, coordTD);
    }

    public static CoordinateRH middleTwo(CoordinateRH coord1, CoordinateRH coord2) {
        CoordinateRH res = null;
        if (coord1.direction == coord2.direction) {
            ...
            try {
                res = new CoordinateRH(coord1.direction, newDeg, newMin, newSec);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
